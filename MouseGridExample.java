...
public class MouseGridExample extends JPanel implements MouseListener
{
  ...
  public void paintComponent(Graphics g)
  {
    ...
    {
      g.drawLine( 50, row*boxSize+100, gridWidth+50, row*boxSize+100);
    }
    
    // Draw the vertical lines
    for(int col = 0; col <= cols; col++)
    {
      g.drawLine( col*boxSize+50, 100, col*boxSize+50, gridHeight+100);
    }
  ...
  public void mousePressed(MouseEvent e)
  {
    ...
    if(button == MouseEvent.BUTTON1 && e.getX() > 50  && e.getY() > 100)// && e.get(Y)) // update later
    {
      x = e.getX()/boxSize;
      y = e.getY()/boxSize;
